        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
          {packages.map((pkg, i) => (
            <motion.div
              ...
              className="cursor-pointer group relative rounded-[26px] border border-[#FFD700]/30 bg-gradient-to-b from-[#111] via-[#120f00] to-[#1a1400] overflow-hidden shadow-[0_0_25px_rgba(255,215,0,0.15)] transition-all duration-500"
            >
        ...
        {selectedPackage && (
          ...
          >
            <motion.div
              ...
              className="bg-[#111] border border-[#FFD700]/40 rounded-3xl w-full max-w-lg p-8 shadow-[0_0_40px_rgba(255,215,0,0.2)] relative"
            >
              <button
                onClick={() => setSelectedPackage(null)}
              ...
              <div className="space-y-4">
                ...
                <input type="text" placeholder="Stay Duration (3 Days / 2 Nights)"
                  value={formData.stay}
                ...
                <input type="text" placeholder="Kids Age (Eg: 5,8)"
